...
@section('content')
<h1 class="text-center text-gray-500 text-3xl tracking-widest"><strong><em>MY BLOGS</em></strong></h1>
<br>
...
<section class="flex justify-center">
    <div
        ...
        <h1 class="text-center text-bold"> {{ $post->title }} </h1><br>
        <p class="tracking-widest"> {{ $post->content }} </p>
        <button class="p-2 object-right-bottom text-center hover:text-blue-900"> <em> continue reading...
            </em></button>
    </div>
